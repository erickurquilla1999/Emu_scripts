...
for d in directories[mpi_rank::mpi_size]:
    ...
    outputfilenamepercell = d+"/reduced_data_per_cell.h5"
    ...
    if do_average and not already_done:
        ...
        avgDatapercell = h5py.File(outputfilenamepercell,"w")

        avgDatapercell.create_dataset("time",data=t)

        avgDatapercell.create_dataset("f00r",data=thisN[0][0])
        avgDatapercell.create_dataset("f01r",data=thisN[0][1])
        avgDatapercell.create_dataset("f02r",data=thisN[0][2])
        avgDatapercell.create_dataset("f10r",data=thisN[1][0])
        avgDatapercell.create_dataset("f11r",data=thisN[1][1])
        avgDatapercell.create_dataset("f12r",data=thisN[1][2])
        avgDatapercell.create_dataset("f20r",data=thisN[2][0])
        avgDatapercell.create_dataset("f21r",data=thisN[2][1])
        avgDatapercell.create_dataset("f22r",data=thisN[2][2])

        avgDatapercell.create_dataset("f00i",data=thisNI[0][0])
        avgDatapercell.create_dataset("f01i",data=thisNI[0][1])
        avgDatapercell.create_dataset("f02i",data=thisNI[0][2])
        avgDatapercell.create_dataset("f10i",data=thisNI[1][0])
        avgDatapercell.create_dataset("f11i",data=thisNI[1][1])
        avgDatapercell.create_dataset("f12i",data=thisNI[1][2])
        avgDatapercell.create_dataset("f20i",data=thisNI[2][0])
        avgDatapercell.create_dataset("f21i",data=thisNI[2][1])
        avgDatapercell.create_dataset("f22i",data=thisNI[2][2])
        ...
        avgDatapercell.create_dataset("f00rbar",data=thisN[0][0])
        avgDatapercell.create_dataset("f01rbar",data=thisN[0][1])
        avgDatapercell.create_dataset("f02rbar",data=thisN[0][2])
        avgDatapercell.create_dataset("f10rbar",data=thisN[1][0])
        avgDatapercell.create_dataset("f11rbar",data=thisN[1][1])
        avgDatapercell.create_dataset("f12rbar",data=thisN[1][2])
        avgDatapercell.create_dataset("f20rbar",data=thisN[2][0])
        avgDatapercell.create_dataset("f21rbar",data=thisN[2][1])
        avgDatapercell.create_dataset("f22rbar",data=thisN[2][2])

        avgDatapercell.create_dataset("f00ibar",data=thisNI[0][0])
        avgDatapercell.create_dataset("f01ibar",data=thisNI[0][1])
        avgDatapercell.create_dataset("f02ibar",data=thisNI[0][2])
        avgDatapercell.create_dataset("f10ibar",data=thisNI[1][0])
        avgDatapercell.create_dataset("f11ibar",data=thisNI[1][1])
        avgDatapercell.create_dataset("f12ibar",data=thisNI[1][2])
        avgDatapercell.create_dataset("f20ibar",data=thisNI[2][0])
        avgDatapercell.create_dataset("f21ibar",data=thisNI[2][1])
        avgDatapercell.create_dataset("f22ibar",data=thisNI[2][2])

        avgDatapercell.close()
