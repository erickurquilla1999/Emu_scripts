...
plt.plot(time[1:],np.absolute(np.array(rhoee_per)[1:]-np.array(rhoee_ori)[1:])) 
plt.yscale('log')  
plt.ylabel(r'$\Delta \rho_{ee}$')
plt.xlabel(r'Time (s)')
plt.savefig('plots/difference_average_rho_ee.pdf')   
plt.clf()
...
plt.plot(time[1:],np.absolute(np.array(rhouu_per)[1:]-np.array(rhouu_ori)[1:])) 
plt.yscale('log')  
plt.ylabel(r'$\Delta \rho_{\mu\mu}$')
plt.xlabel(r'Time (s)')
plt.savefig('plots/difference_average_rho_uu.pdf')   
plt.clf()
...
plt.plot(time[1:],np.absolute(np.array(rhott_per)[1:]-np.array(rhott_ori)[1:])) 
plt.yscale('log')  
plt.ylabel(r'$\Delta \rho_{\tau\tau}$')
plt.xlabel(r'Time (s)')
plt.savefig('plots/difference_average_rho_tt.pdf')   
plt.clf()
...
plt.plot(time[1:],np.absolute(np.array(rhoeu_per)[1:]-np.array(rhoeu_ori)[1:])) 
plt.yscale('log')  
plt.ylabel(r'$\Delta \rho_{e\mu}$')
plt.xlabel(r'Time (s)')
plt.savefig('plots/difference_average_rho_eu.pdf')   
plt.clf()
