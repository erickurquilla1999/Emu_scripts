...
filename_bang   = basedirs[2]+simlist[2]+"sim1/from_payne/v0/reduced_data_fft_power_NSM_sim_hdf5_chk.h5"
filename_emu_2f_avg = basedirs[0]+simlist[0]+"reduced_data.h5"
filename_emu_3f_avg = basedirs[1]+simlist[1]+"reduced_data.h5"
filename_bang_avg   = basedirs[2]+simlist[2]+"sim1/from_payne/v0/reduced_data_NSM_sim_hdf5_chk.h5"
